...
export default function Footer() {
  return (
    <footer className="bg-white/5" aria-labelledby="footer-heading">
      <div className="border-b mx-6 pb-6 border-gray-700/50 pt-8 lg:flex lg:items-center lg:justify-between xl:mt-0">
        <div>
          <h3 className="text-base font-medium font-semibold text-white">
